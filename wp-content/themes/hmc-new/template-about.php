  ...
  <div class="container">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-6 about-images aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        <div class="row gy-4">
          <div class="col-lg-6">
            <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/about-company-1.jpg" class="img-fluid"
              alt="">
          </div>
          <div class="col-lg-6">
            <div class="row gy-4">
              <div class="col-lg-12">
                <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/about-company-2.jpg"
                  class="img-fluid" alt="">
              </div>
              <div class="col-lg-12">
                <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/about-company-3.jpg"
                  class="img-fluid" alt="">
              </div>
            </div>
          </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-around gy-4">
      <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img
          src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/features-bg.jpg" alt=""></div>
