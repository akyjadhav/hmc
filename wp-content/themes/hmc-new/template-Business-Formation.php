  ...
  <div class="container section">
    ...
    <div class="row align-items-center content-block">
      ...
      <div class="col-md-6 animate__animated animate__fadeInRight">
        <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/bf1.jpeg" alt="Mainland" class="img-fluid shadow-lg p-4 mb-5 bg-white rounded">
      </div>
    </div>
    ...
    <div class="row align-items-center content-block flex-md-row-reverse">
      ...
      <div class="col-md-6 animate__animated animate__fadeInLeft">
        <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/bf2.jpeg" alt="Free Zone" class="shadow-lg p-4 mb-5 bg-white rounded img-fluid">
      </div>
    </div>
    ...
    <div class="row align-items-center content-block">
      ...
      <div class="col-md-6 animate__animated animate__fadeInRight">
        <img src="<?php echo home_url(); ?>/wp-content/themes/hmc-new/assets/img/bf3.jpeg" alt="Offshore" class="shadow-lg p-4 mb-5 bg-white rounded img-fluid">
      </div>
    </div>
  </div>
